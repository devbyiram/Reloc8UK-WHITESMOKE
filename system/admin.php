				...
				<tbody>
					...
					<tr>
						...
						<td><div class="btn-group">
								...
								<?php } ?>
								<a href="admin-manage-bids.php?action=accept&bid=<?php echo $bid['id']; ?>" class="btn btn-sm btn-primary" data-id="<?php echo $bid['id']; ?>">Approve</a>
								<a href="admin-manage-bids.php?action=reject&bid=<?php echo $bid['id']; ?>" class="btn btn-sm btn-danger" data-id="<?php echo $bid['id']; ?>">Reject</a>
							</div></td>
					</tr>
					<?php
						}
